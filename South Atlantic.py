...
Aims:
    - Import MATLAB files related to South Atlantic basin
    - Plot initial data
...
LOAD_OPTION = input("Load Argo data for South Atlantic? (y/[n])\n")
if LOAD_OPTION == "y":
...
plt.figure()
# Contour plot of salinity in the South Atlantic
#plt.subplot(1, 2, 1)
...
# Contour plot of temperature in the South Atlantic
plt.figure()
#plt.subplot(1, 2, 2)
...
# Formatting figure
#plt.suptitle("Zonal and Time Mean Temperature, Argo Interpolated Product (South Atlantic)",
#             fontweight="semibold")
#plt.tight_layout()
...
MS_plot(FEATURES_C, "Temperature/ Salinity", " ", False, FEATURES_C,
        LATITUDE, PRESSURE, LATG, PRES, "South Atlantic")
...
for i in range(len(TYPE)):
    ...
    # Formatting subplots
    TITLE = TYPE[i] + " Clusters (South Atlantic)\nEstimated Clusters: %d"
...
BIC_plot(PSALS, 1, 10, False, "Salinity", "Atlantic")

# For only temperature as a feature
BIC_plot(TEMPS, 1, 10, False, "Temperature", "Atlantic")

# For salinity and temperature as features
BIC_plot(FEATURES_C, 1, 10, False, "Temperature/ Salinity", "Atlantic")

# For salinity, temperature and density as features
BIC_plot(FEATURES_D, 1, 10, False, "Temperature/ Salinity/ Density", "Atlantic")
